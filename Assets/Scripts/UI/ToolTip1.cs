...
public class ToolTip1 : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    UI_Skill_Info1 _ui_Skill1_Info;
    ...
    void Start()
    {
        _ui_Skill1_Info = GameObject.FindAnyObjectByType<UI_Skill_Info1>();
    }
    ...
    public void OnPointerExit(PointerEventData eventData)
    {
        if (_ui_Skill1_Info != null)
        {
            _ui_Skill1_Info.gameObject.GetComponent<Canvas>().enabled = false; // 툴팁 비활성화
        }
    }
}
